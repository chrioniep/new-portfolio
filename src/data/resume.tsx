...
export const DATA = {
  ...
  summary:
    "Software Engineer specializing in web solutions, with a track record of contributing to and leading diverse projects across various industries. Passionate about building scalable and impactful digital experiences for companies, I thrive on solving complex problems and delivering quality solutions that drive success",
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/chrioniep",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/crionieponde/",
        icon: Icons.linkedin,
  ...
  work: [
    ...
    },
    {
      ...
      badges: [],
      href: "https://infinifieldsservices.com/",
      location: "Remote",
      title: "Software Engineer",
      logoUrl: "/companies/infini.png",
      start: "January 2021",
      end: "January 2022",
      description:
  ...
  education: [
    {
      ...
      degree: "certificate",
      logoUrl: "/epicreact.png",
      start: "2020",
      end: "2021",
    },
    {
      school: "Institut Superieur Informatique Programmation et Analyse",
      href: "https://isipa.cd",
      degree: "Associat Degree (Graduat)",
      logoUrl: "/schools/isipa.png",
      start: "2017",
      end: "2020",
    },
  ],
  projects: [
    {
      ...
      image: "/logozanaat-bg.jpeg",
      video: "",
    },
    {
      title: "CaseZanaat",
      href: "https://casezanaat.vercel.app/",
      dates: "June 2023 - Present",
      active: true,
      description:
        "Your one-stop-shop for creating an image on a custom Phone case",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/chrioniep/casezanaat",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/casezanaat-bg.jpeg",
      video: "",
    },
    {
      ...
      active: true,
      description:
        "Web application for tracking meteorite strikes in the world",
      technologies: [
        "React",
        "Javascript",
        "TailwindCSS",
      ...
      links: [
        {
          type: "Website",
          href: "https://meteorite-strike.web.app/",
          icon: <Icons.globe className="size-3" />,
        },
        {
          type: "Source",
          href: "https://github.com/chrioniep/meteorite-strike",
          icon: <Icons.github className="size-3" />,
        },
      ],
    ...
    {
      title: "Perishopp",
      href: "https://perishopp-web.web.app/",
      dates: "Nov 2021 - Dec 2021",
      active: true,
      description: "Ecommerce website",
      technologies: ["Vuejs", "Javascript", "TailwindCSS", "Firebase"],
      links: [
        {
          type: "Website",
          href: "https://perishopp-web.web.app/",
